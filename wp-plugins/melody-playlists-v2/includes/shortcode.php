...
function melody_playlist_manager_shortcode() {
    ...
    */
    ...
    if (isset($_GET['melody_logout'])) {
        melody_logout();
        wp_redirect(remove_query_arg('melody_logout'));
        exit;
    }

    /*
    |--------------------------------------------------------------------------
    | LOGIN GATE (REPLACES WP LOGIN)
    |--------------------------------------------------------------------------
    */
    ...
    if (!melody_is_logged_in()) {
        ...
        if (isset($_POST['melody_login_submit'])) {

            $username = sanitize_text_field($_POST['username']);
            $password = $_POST['password'];

            if (melody_login($username, $password)) {
        ...
        <div class="melody-container">
            ...
            <form method="POST">
                ...
                <button type="submit" name="melody_login_submit">
                    Login
                </button>
    ...
    if (isset($_POST['melody_add_video'])) {
        ...
        if ($youtube_id) {
            ...
            if (!$exists) {
                ...
                $title = melody_get_youtube_title($youtube_url);
    ...
    */
    ...
    <div class="melody-container">
        ...
        <div style="display:flex;justify-content:space-between;align-items:center;">
            ...
            <a href="?melody_logout=1">Logout</a>
        </div>
        ...
        <div class="melody-box">
            ...
            <form method="POST">
                ...
                <button type="submit" name="melody_create_playlist">
                    Create Playlist
                </button>
        ...
        <div class="melody-box">
            ...
            <form method="POST">
                ...
                <button type="submit" name="melody_add_video">
                    Add Video
                </button>
